...
public class FileInformation {
	...
	/**
	 * Opens the file and returns a {@code BufferedReader} object using
	 * the given encoding.
	 *
	 * @param encoding the encoding to use
	 * @return the open file as {@code BufferdReader}
	...
	/**
	 * Opens the file and returns a {@code InputStream} object.
	 *
	 * @return the open file as {@code InputStream}
	 * @throws IOException thrown if the file could not be read
	 */
