...
public class CSVRecordReader implements FileRecordReader {
	 ...
	 *
	 * @throws java.io.IOException Exception when stream cannot be closed.
	 */
	@Override
	 ...
	 *
	 * @return next field's value, or {@code null}, if the last column has
	 * been reached.
	 */
	@Override
	 ...
	 *
	 * @return {@code true} if {@link #nextField()} will return values,
