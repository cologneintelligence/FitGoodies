...
public class WaitForResult {
     ...
     *
     * @param target    Object which receives the call.
     * @param method    Method to invoke on {@code target}.
     * @param maxTime   Maximum time to wait before causing a failure.
     * @param sleepTime Time to sleep between method calls.
     */
