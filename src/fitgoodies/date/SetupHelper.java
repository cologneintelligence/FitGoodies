...
/**
 * Singleton class which holds information about date formats and
 * allows to parse date string. <br /><br />
 *
 * This class should be used whenever a
 * {@link fitgoodies.adapters.AbstractTypeAdapter} or a {@link fitgoodies.parsers.Parser}
 * parses a date.
 *
 * @author jwierum
...
public final class SetupHelper {
	...
	/**
	 * Resets the <code>SetupHelper</code>.
	 */
